...
class AllProductPageAdapter(private var listProduct:MutableList<Product>):RecyclerView.Adapter<AllProductPageAdapter.AllProductViewHolder>() {
    ...
    inner class AllProductViewHolder(private val binding:ProductItemBinding):RecyclerView.ViewHolder(binding.root){
        fun bind(item:Product){
            ...
            binding.tvViewSearch.text = item.view.toString()
